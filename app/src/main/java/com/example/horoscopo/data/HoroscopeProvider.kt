...
class HoroscopeProvider
{
    companion object
    {
        private val horoscopeList: List<Horoscope> = listOf(
            ...
            Horoscope("taurus",R.string.horoscope_date_taurus, R.string.horoscope_date_taurus, R.drawable.taurus_icon),
            ...
            Horoscope("capricorn",R.string.horoscopo_name_capricorn,R.string.horoscopo_name_capricorn,R.drawable.capricornus_icon),
            ...
            Horoscope("virgo",R.string.horoscopo_name_virgo,R.string.horoscopo_name_virgo, R.drawable.virgo_icon),
            Horoscope("scorpio", R.string.horoscopo_name_scorpio,R.string.horoscopo_name_scorpio, R.drawable.scorpio_icon)
        )

        fun findAll(id: Int): List<Horoscope>
        {
